...
class TestChebyshev(unittest.TestCase):
    def setUp(self):
        ...
        self.dy2 = -(arg ** 2) * np.sin(arg * self.x) - arg ** 2 * np.cos(arg * self.x)
    ...
    def test_project(self):
        ...
        print("|pypde - numpy|: {:5.2e}".format(norm))
    ...
    def test_deriv2_dm(self):
        ...
        print("fft |pypde - analytical|: {:5.2e}".format(norm))
...
class TestChebyshev2D(unittest.TestCase):
    ...
    def test_dct(self):
        ...
        print("|f_after - f_before|: {:5.2e}".format(norm))
